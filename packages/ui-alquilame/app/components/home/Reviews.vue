<template>
  <!--
    ...
    CARDS: render three real, verbatim Google reviews from the local audited
    source. The avatar uses derived initials over the brand circle
    (circulo-rojo.svg), matching the golden bicolor avatar.
  ...
  <section id="google-reviews" class="py-12 md:py-16 bg-gray-100">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <!-- Featured cards — audited, verbatim Google reviews -->
        <div class="grid sm:grid-cols-3 gap-4 lg:gap-5">
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="mt-2.5 body-sm leading-relaxed whitespace-pre-line">
                &ldquo;{{ testimonio.quote }}&rdquo;
              </p>
              <p v-if="testimonio.relativeDate" class="mt-2 text-xs text-gray-500">
...
// The home surfaces the first three audited reviews; city pages use a stable
// slug-specific selection from the same source.
const testimonios = googleReviews.slice(0, 3);
