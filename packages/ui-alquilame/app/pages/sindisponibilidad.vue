<template>
  ...
  <div class="text-white max-w-2xl mx-auto text-center py-12 px-4 [--ctx-text-primary:#fff]">
    ...
    <div class="bg-white/10 rounded-2xl p-6 mb-6">
      ...
      <NuxtLink
        :to="searchUrl"
        class="inline-flex items-center justify-center rounded-full bg-red-600 text-white font-semibold px-6 py-3 shadow-lg shadow-black/15 hover:bg-red-700 transition-colors"
      >
        Modificar búsqueda
      </NuxtLink>
    </div>
