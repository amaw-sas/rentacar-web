<template>
  ...
  <div class="bg-white min-h-dvh">
    <section class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 text-center">
      ...
      >
        Abrir la ficha de Alquilame en Google
      </a>
    </section>
 ...
 *
 * Reemplaza la página que vivía en GoHighLevel. Allí las 1-3★ apuntaban a
 * `rentacar.alquilame.co`, un dominio SIN registro DNS: el cliente descontento
 * terminaba en un error de conexión. Esa rama nunca existió — el propio código
 * traía el `// ¡REMPLAZA FORM_URL CON TU FORMULARIO!`. Aquí sí existe, y no
 * navega a ninguna parte: el formulario aparece en esta misma página.
 *
...
// Con el layout por defecto, igual que /quejas-y-reclamos, /aliados y /gana.
...
/** Ficha de Google Business Profile de alquilame. */
...
useSeoMeta({
  description: 'Cuéntanos cómo te fue con tu alquiler de carro en Alquilame.',
})
</script>
