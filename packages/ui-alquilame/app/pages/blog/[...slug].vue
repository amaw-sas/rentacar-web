          ...
          <article ref="articleRef" class="lg:w-2/3 prose prose-lg prose-gray max-w-none">
            ...
            <section class="not-prose lg:hidden mt-12 border-t border-gray-200 pt-8">
              ...
              <button
                ...
                @click="shareNative"
                type="button"
                class="w-full inline-flex items-center justify-center gap-2 bg-brand-600 hover:bg-brand-700 text-white px-5 py-3 rounded-lg font-medium transition-colors"
              >
              ...
              <button
                @click="copyLink"
                type="button"
                class="mt-3 inline-flex items-center gap-2 text-sm font-medium text-gray-600 hover:text-brand-700 transition-colors"
              >
