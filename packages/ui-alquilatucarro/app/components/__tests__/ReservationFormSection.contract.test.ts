...
/**
 * Contract for ReservationFormSection script + template bindings.
 * Catches incomplete PR6 flight-trap edits (missing formState/schema,
 * typo `const onst`) that button string-scans cannot see.
 */
