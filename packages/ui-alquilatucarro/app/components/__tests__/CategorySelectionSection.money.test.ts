...
/**
 * Issue 322 PR1 — dinero en deep-link / kilometraje / Seguro Total (grid).
 * Holdout: docs/specs/issue-322-pr1-money/scenarios/grid-deeplink-money.scenarios.md
 *
 * Tests estructurales (leen la fuente), mismo patrón que
 * packages/ui-alquicarros/tests/wizard-monthly-mileage.test.ts.
 */
