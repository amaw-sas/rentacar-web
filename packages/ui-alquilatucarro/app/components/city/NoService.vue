      ...
      <template v-if="nearby.length > 0">
        ...
        <div class="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
          <NuxtLink
            ...
            :key="city.id"
            :to="`/${city.id}`"
            class="inline-flex items-center justify-center rounded-lg bg-red-700 px-5 py-3 font-semibold text-white transition-colors duration-200 hover:bg-red-800"
          >
