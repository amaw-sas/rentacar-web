<template>
  <!--
    ...
    bg-brand-600), a .heading-section title (Plus Jakarta) and relaxed body copy.
      ...
      <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-center">
        ...
        <div class="flex flex-col gap-0 text-center">
          ...
          <div class="flex items-center w-full my-3 md:my-4">
            ...
            <div class="mx-4 w-2.5 h-2.5 bg-brand-600 rotate-45 rounded-[2px]"></div>
            <div class="flex-grow border-t border-gray-200"></div>
          </div>
        </div>
        ...
        <div class="md:self-center">
          ...
          <div class="h-1 w-10 rounded-full bg-brand-600 mb-5 mx-auto md:mx-0"></div>
          <p
