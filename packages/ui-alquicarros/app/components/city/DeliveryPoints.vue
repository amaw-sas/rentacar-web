        ...
        >
          <div class="flex-1 min-w-0 flex flex-col justify-center gap-2.5 py-1">
            <div class="flex items-start gap-3">
              <!-- Brand gradient location pin (naranja; icono oscuro por contraste sobre naranja) -->
              <span
                class="shrink-0 w-9 h-9 rounded-full bg-linear-to-br from-brand-500 to-brand-700 text-gray-900 flex items-center justify-center shadow-[0_4px_10px_rgba(239,150,0,0.30)]"
                aria-hidden="true"
              >
