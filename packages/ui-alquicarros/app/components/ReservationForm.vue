  ...
  >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
        ...
        <template v-if="formState.conductorAdicional">
          <p class="md:col-span-2 text-sm font-semibold text-gray-900 mt-2">Conductor adicional</p>
          <u-form-field class="md:col-span-2" name="conductorAdicionalNombre" label="Nombre del conductor adicional">
            <u-input
          ...
          <u-form-field class="md:col-span-2" name="conductorAdicionalIdentificacion" label="Cédula o documento del conductor adicional">
            <u-input
          ...
          <p class="md:col-span-2 text-xs text-gray-600" data-testid="extra-driver-notice">
