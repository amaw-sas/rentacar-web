...
| Valor en el campo combustible del RUNT | Matriculados en Colombia | En Bogotá |
|---|---:|---:|
| `GASO ELEC` | 239.851 | 102.900 |
| `ELECTRICO` | 89.900 | 38.790 |
| `DIES ELEC` | 3.146 | 1.062 |
| `HIDROGENO` | 4 | 1 |
...
| `GASO ELEC` o `DIES ELEC` | Híbrido | Exento por decisión de Bogotá (numeral 17) | **No exento** |
| `GASOLINA` en un carro que la marca vende como *hybrid* | Carro de gasolina | **No exento** | **No exento** |
| `GAS`, `GNV`, `GAS GASOL`, `GLP` | Vehículo a gas | **No exento** en Bogotá. Sí en Medellín, Bello y Sabaneta | **No exento** |
